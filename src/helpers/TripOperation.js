export const DeleteAccount = async (accountId, tripId, partyId) => {
  try {
...
export const fetchTripRoute = async (tripId) => {
  if (tripId != '') {
...
export const handleEditAccount = async (editedItem, tripId, partyId) => {
  try {
...
export async function extractEWayBillDetails(text) {
  const prompt = `
